...
import {articleCategoryListService, articleListService, addArticleService} from '@/api/article.js'
//文章分类数据模型
const categorys = ref([{
  "id": 3,
  "categoryName": "美食",
...
//   articleModel.value.coverImg = img.data
    ...
    articleModel.value.coverImg = "https://big-event-gwd.oss-cn-beijing.aliyuncs.com/9bf1cf5b-1420-4c1b-91ad-e0f4631cbed4.png"
}
//添加文章
const addArticle = async () => {
    console.log('img=', articleModel.value.coverImg);
  let params = {
...
<template>
  ...
  <el-drawer v-model="visibleDrawer" title="添加文章" direction="rtl" size="50%">
    ...
    <el-form :model="articleModel" label-width="100px">
      ...
      <el-form-item>
        <el-button type="primary" @click="articleModel.state='已发布';addArticle()">发布</el-button>
        <el-button type="info" @click="articleModel.state='草稿';addArticle()">草稿</el-button>
      </el-form-item>
    </el-form>
  </el-drawer>
</template>
